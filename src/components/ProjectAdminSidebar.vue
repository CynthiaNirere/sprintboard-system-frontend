  ...
  <v-navigation-drawer permanent>
    <div class="d-flex flex-column fill-height">
      ...
      <div id="navLinks" class="d-flex ga-2 flex-column flex-grow-1 overflow-y-auto">
        ...
        <v-list-item :to="{ name: 'projectAdminBacklog' }" class="mx-3 rounded-lg" active-class="active-tab">
          <div class="d-flex ga-3 align-center">
        ...
        <v-list-item :to="{ name: 'projectAdminTeamManagement' }" class="mx-3 rounded-lg" active-class="active-tab">
          <div class="d-flex ga-3 align-center">
